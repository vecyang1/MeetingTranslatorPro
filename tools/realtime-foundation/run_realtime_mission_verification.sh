...
run_shell "installed app runtime inspection" \
  'open "/Applications/MeetingTranslator.app"; sleep 2; pgrep -fl "Meeting Translator|MeetingTranslator"; osascript -e '\''id of app "Meeting Translator"'\'' >/tmp/mtp_bundle_id.txt; grep -Fxq com.meetingtranslator.app /tmp/mtp_bundle_id.txt; /usr/libexec/PlistBuddy -c "Print :CFBundleShortVersionString" "/Applications/MeetingTranslator.app/Contents/Info.plist" | grep -Fxq 1.1.4; /usr/libexec/PlistBuddy -c "Print :CFBundleVersion" "/Applications/MeetingTranslator.app/Contents/Info.plist" | grep -Fxq 6; codesign -dv --verbose=4 "/Applications/MeetingTranslator.app" 2>&1 | grep -F "Identifier=com.meetingtranslator.app"; strings "/Applications/MeetingTranslator.app/Contents/MacOS/MeetingTranslator" | grep -F "Live Interpretation"'

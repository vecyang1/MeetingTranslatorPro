...
This project is indexed by GitNexus as **MeetingTranslatorPro** (2150 symbols, 4950 relationships, 150 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Managers area (99 symbols) | `.claude/skills/generated/managers/SKILL.md` |
